...
- **Canvas:** `W` × `H`, set by `width` and `height` in `src/config.js` (here 1080×1920, 9:16 portrait; the kit's original is 1920×1080), origin top-left, y down. Use `W` and `H` instead of hard-coded numbers.
