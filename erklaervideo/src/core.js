...
function makeGrain() {
  ...
  const D = Math.hypot(W, H) / 2, g = c.createRadialGradient(W / 2, H / 2, D * .44, W / 2, H / 2, D * 1.03); g.addColorStop(0, 'rgba(255,255,255,0)'); g.addColorStop(1, 'rgba(120,95,70,.35)');   // same vignette in any aspect
